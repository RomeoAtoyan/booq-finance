  ...
  return (
    <nav className="flex items-center px-8 py-4 bg-white border-b border-gray-100 sticky top-0 z-50">
      <div className="flex items-center space-x-10">
        <Link to="/" className="flex items-center justify-center w-16 h-10 bg-[#4F7CFF] rounded-xl text-white shadow-sm hover:opacity-90 transition-opacity">
          booq
        </Link>
        ...
        <div className="flex items-center space-x-8">
          <Link
            ...
            className={`relative text-[15px] font-semibold transition-colors ${
              isProjectsActive ? "text-[#4F7CFF]" : "text-gray-500 hover:text-gray-900"
            }`}
          >
            Projects
            {isProjectsActive && (
